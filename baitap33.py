...
Original file is located at
    https://colab.research.google.com/drive/12WTlkHBbYlV5ESQaRQ3KhcOH9__svaSR
"""
...
def pipeline_model(path):
    ...
    faceDetectionModel = '/content/drive/MyDrive/TestOpCV/models/res10_300x300_ssd_iter_140000_fp16.caffemodel';

    # Mô tả kiến trúc
    faceDetectionProto = '/content/drive/MyDrive/TestOpCV/models/deploy.prototxt.txt.prototxt'

    # Mô hình mô tả khuôn mặt
    faceDescriptor = '/content/drive/MyDrive/TestOpCV/models/openface.nn4.small2.v1.t7'
    ...
    # face recognition
    face_recognition_model = pickle.load(open('/content/drive/MyDrive/TestOpCV/ml_face_person_identity.pkl',
                                            mode='rb'))
    # pipeline model
    img = cv2.imread(path)
    image = img.copy()
...
img, results = pipeline_model('/content/drive/MyDrive/TestOpCV/FaceImage/1721030544_TranQuangBinh/image_180.jpg')
cv2_imshow(img)
